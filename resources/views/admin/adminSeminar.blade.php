		...
		<thead class="block md:table-header-group">
			...
			<tr class="bg-white border border-grey-500 md:border-none block md:table-row text-xs">
				...
				<td class="p-2 md:border md:border-grey-500 text-left block md:table-cell">
				    ...
				    <div id="modal" class="fixed inset-0 bg-black bg-opacity-50 justify-center items-center hidden">
                      <div class="bg-white p-6 rounded-lg">
                        		  <div id="modal" class="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center overflow-y-auto">
