<x-dosen-layout :title="'Logbook Mahasiswa'">
    ...
    <div class="flex space-x-4 mt-8">
        ...
        <!-- Main modal -->
        <div id="authentication-modal" tabindex="-1" aria-hidden="true" class="fixed inset-0 top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto h-[calc(100%-1rem)] max-h-full">
