...
<div class="sidebar fixed z-20 top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-sidebar">
    ...
    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-hover text-white">
        ...
        <a class="text-[15px] ml-4 text-gray-200 font-bold" href="{{route('dosen.logbook')}}">Logbook</a>
    </div>
    <!-- <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-hover text-white">
    ...
    <div class="flex-col">
        <div class="p-2.5 mt-3 rounded-md px-4 duration-300 cursor-pointer text-white hover:bg-hover">
            <button class="flex items-center" aria-controls="dropdown-user" data-collapse-toggle="dropdown-user">
                <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512" fill="white"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM609.3 512H471.4c5.4-9.4 8.6-20.3 8.6-32v-8c0-60.7-27.1-115.2-69.8-151.8c2.4-.1 4.7-.2 7.1-.2h61.4C567.8 320 640 392.2 640 481.3c0 17-13.8 30.7-30.7 30.7zM432 256c-31 0-59-12.6-79.3-32.9C372.4 196.5 384 163.6 384 128c0-26.8-6.6-52.1-18.3-74.3C384.3 40.1 407.2 32 432 32c61.9 0 112 50.1 112 112s-50.1 112-112 112z" />
                </svg>
    ...
    <div class="flex-col">
        <div class="p-2.5 mt-3 rounded-md px-4 duration-300 cursor-pointer text-white hover:bg-hover">
            <button class="flex items-center" aria-controls="dropdown-pengajuan" data-collapse-toggle="dropdown-pengajuan">
                ...
                <a class="text-[15px] ml-4 text-gray-200 font-bold">Daftar Pengajuan</a>
            </button>
        </div>
    ...
    <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-hover text-white">
        <svg xmlns="http://www.w3.org/2000/svg" height="1.25em" viewBox="0 0 512 512" class="ml-1" fill="white"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M502.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-128-128c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 224 192 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l210.7 0-73.4 73.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l128-128zM160 96c17.7 0 32-14.3 32-32s-14.3-32-32-32L96 32C43 32 0 75 0 128L0 384c0 53 43 96 96 96l64 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-64 0c-17.7 0-32-14.3-32-32l0-256c0-17.7 14.3-32 32-32l64 0z" /></svg>
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button class="text-[15px] ml-3 text-gray-200 font-bold" :href="route('logout')" onclick="event.preventDefault();
                                                this.closest('form').submit();">Logout</button>
